...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <a href="{{ route('index') }}" class="btn btn-primary">Back to Movies List</a>
            <a href="{{ route('edit', $movie->id) }}" class="btn btn-warning">Edit Movie</a>
            <form action="{{ route('destroy', $movie->id) }}" method="POST" style="display:inline-block;">
                @csrf
                @method('DELETE')
