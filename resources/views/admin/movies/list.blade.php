            ...
            <tbody>
                @foreach ($movies as $movie)
                    <tr>
                        ...
                        <td class="d-flex">
                            <a href="{{ route('admin.show', $movie->id) }}" class="btn btn-info" title="Detail"><i class="bi bi-eye-fill"></i></a>
                            <a href="{{ route('admin.edit', $movie->id) }}" class="btn btn-warning mx-1" title="Edit"><i class="bi bi-pencil-square"></i></a>
